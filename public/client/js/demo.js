...
//   // Select the element with the position: fixed property
//   const fixedElement = document.querySelector(".content");

//   // Get the element's initial top position
//   const elementTop = fixedElement.offsetTop;

//   // Set the scroll event listener
//   window.addEventListener("scroll", function () {
//     // Check the scroll position
//     if (window.scrollY > elementTop) {
//       // Hide the element if the user scrolls past its initial position
//       fixedElement.style.display = "none";
//     } else {
//       // Show the element when the user scrolls back to its position
